	...
	public static void showInformation(Player client) {
		...
		if (client.RomeoAndJuliet == 0) {
			...
			client.getPacketSender().sendString("found in Varrock Square.",
					8148);
		} else if (client.RomeoAndJuliet == 1) {
		...
		} else if (client.RomeoAndJuliet == 2) {
			client.getPacketSender()
					.sendString(
							"@str@To start the quest, you should talk with Romeo",
							8147);
			...
			client.getPacketSender().sendString("Could this be for Romeo?",
					8156);
		} else if (client.RomeoAndJuliet == 4) {
			client.getPacketSender()
					.sendString(
							"@str@To start the quest, you should talk with Romeo",
							8147);
		...
		} else if (client.RomeoAndJuliet == 5) {
			client.getPacketSender()
					.sendString(
							"@str@To start the quest, you should talk with Romeo",
							8147);
		...
		} else if (client.RomeoAndJuliet == 6) {
			client.getPacketSender()
					.sendString(
							"@str@To start the quest, you should talk with Romeo",
							8147);
		...
		} else if (client.RomeoAndJuliet == 7) {
			client.getPacketSender()
					.sendString(
							"@str@To start the quest, you should talk with Romeo",
							8147);
		...
		} else if (client.RomeoAndJuliet == 8) {
			client.getPacketSender()
					.sendString(
							"@str@To start the quest, you should talk with Romeo",
							8147);
		...
		} else if (client.RomeoAndJuliet == 9) {
			client.getPacketSender()
					.sendString(
							"@str@To start the quest, you should talk with Romeo",
							8147);
